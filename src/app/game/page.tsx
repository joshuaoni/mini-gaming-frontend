...
export default function GamePage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            ...
            <div className="w-96 p-8 shadow-lg rounded-lg bg-white mt-12">
                <h2 className="text-2xl font-bold text-center text-gray-800 mb-6">Coin Game</h2>
                ...
                <div className="flex justify-between mb-4">
                    <button
                        ...
                        className={`w-24 py-2 rounded-lg ${
                ...
                <input
                    ...
                    className="w-full p-3 border border-gray-300 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4"
                />
                ...
                <button
                    ...
                    className="w-full bg-blue-500 font-semibold text-white py-3 rounded-lg hover:bg-blue-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
                    disabled={spinning}
                >
                ...
                {result && !spinning && (
                <p className="flex justify-center mt-2 text-gray-800 font-semibold">
                    {result === coinFace ? (
